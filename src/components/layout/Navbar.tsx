        ...
        <header className="sticky top-0 z-50 w-full border-b border-border/80 bg-[#f7f3ef]/95 backdrop-blur-xl">
            <div className="mx-auto flex w-full max-w-[1360px] items-center gap-3 px-4 py-4 sm:px-6 lg:px-8">
                ...
                <div className="ml-auto flex items-center gap-1 sm:gap-2">
                    ...
                    {session?.user ? (
                        <Link href="/dashboard" className="hidden h-11 items-center gap-2 rounded-full border border-border bg-card px-4 text-sm text-foreground hover:bg-secondary sm:flex">
                    ...
                    {session?.user ? (
                        <Link href="/dashboard" className="flex h-11 w-11 items-center justify-center rounded-full border border-border bg-card text-foreground hover:bg-secondary sm:hidden">
